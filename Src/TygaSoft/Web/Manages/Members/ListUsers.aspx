...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" runat="server">
    ...
    <div class="easyui-layout" data-options="fit:true">
        ...
        <div data-options="region:'center',title:''">
            <div id="toolbar" style="padding: 5px;">
                ...
                <a class="easyui-linkbutton" data-options="iconCls:'icon-edit',plain:true" onclick="ListUser.SetUserProfile()" style="display:none;">用户个性化</a>
                <div class="fr">
    ...
    <script type="text/javascript" src="/Qdhtyy/Scripts/DlgFiles.js"></script>
    <script type="text/javascript" src="/Qdhtyy/Scripts/Manages/Members/ListUser.js"></script>
    <script type="text/javascript" src="/Qdhtyy/Scripts/Manages/Sys/SiteMulti.js"></script>
