...
namespace TygaSoft.SqlServerDAL
{
    public partial class SiteUsers
    {
        ...
        public bool ValidateUser(string username, string password)
        {
            ...
            var obj = SqlHelper.ExecuteScalar(SqlHelper.QdhtyyDbConnString, "SDP_GetOper", parms);
        ...
        public bool IsExistUserName(string username,Guid Id)
        {
            ...
            object obj = SqlHelper.ExecuteScalar(SqlHelper.QdhtyyDbConnString, CommandType.Text, cmdText, parms);
            if (obj != null) return true;
        ...
        public SiteUsersInfo GetModel(string username)
        {
            ...
            using (SqlDataReader reader = SqlHelper.ExecuteReader(SqlHelper.QdhtyyDbConnString, CommandType.Text, cmdText, parm))
            {
                if (reader != null)
                {
                    if (reader.Read())
        ...
        public SiteUsersInfo GetModelByJoin(string username,object Id)
        {
            ...
            using (SqlDataReader reader = SqlHelper.ExecuteReader(SqlHelper.QdhtyyDbConnString, CommandType.Text, sb.ToString(), parm))
            {
                if (reader != null)
                {
                    if (reader.Read())
