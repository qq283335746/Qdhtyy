...
(function($){
function _afb(_afc){
var _Qdhtyy=$.data(_afc,"combotreegrid");
var opts=_Qdhtyy.options;
...
_Qdhtyy.grid=$("<table></table>").appendTo(_b01);
}
_Qdhtyy.grid.treegrid($.extend({},opts,{border:false,checkbox:opts.multiple,onLoadSuccess:function(row,data){
