...
<body>
    ...
    <div class="w login">
        <div class="main">
            <div class="loginl">
	            <img src="/Qdhtyy/Images/loginl.jpg" alt="" />
            </div>
            <div class="loginr">
                ...
                <div id="loginInfo" class="content">
                    ...
                    <div class="control-group">
                        ...
                        <img border="0" id="imgCode" src="/Qdhtyy/h/vc.html?vcType=login" alt="看不清，单击换一张" onclick="this.src='/Qdhtyy/h/vc.html?vcType=login&abc='+Math.random()" style="vertical-align:middle;line-height: 38px;height: 38px; width:100px; margin-bottom:3px;" />
                    </div>
    ...
    <script type="text/javascript" src="/Qdhtyy/Scripts/Login.js"></script>
