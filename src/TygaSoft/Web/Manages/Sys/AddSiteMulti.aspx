...
<body>
    ...
    <div>
        ...
        <div class="row mt10"><span class="rl w100">站点Logo：</span>
            <div class="fl">
                <img id="imgSiteLogo" src="/Qdhtyy/Images/nopic.gif" alt="请选择图片" width="200" height="100" onclick="DlgFiles.DlgPictureSelect('Logo',false,SiteMulti.OnSiteLogoCallBack)" />
            </div>
        </div>
